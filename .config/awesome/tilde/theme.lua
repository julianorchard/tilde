...
--  Tag Added:   2022-05-03
--  Description: Tilde; based on Blackburn (github.com/lcpz)
...
local barcolor  = gears.color({
    ...
    stops = { {0, "#110000" }, {0.6, theme.border_normal}, {1, "#001111"} }
})
...
theme.titlebar_bg_focus = gears.color({
    ...
    from  = { barheight, 0 },
    to    = { barheight, barheight },
    stops = { {0, theme.bg_normal}, {0.6, theme.border_normal}, {1, "#222222"} }
})
